<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }} " class="flex items-center">
                        <img src="{{ asset('images/logo-upi3.png') }}" alt="Application Logo" class="block h-12 w-12" />
                        <span class="dark:text-white ml-4 text-lg">TE-LabPlatform</span>
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('assets.index')" :active="request()->routeIs('assets.index')
                         || request()->routeIs('assets.show') || request()->routeIs('assets.edit')">
                        {{ __('My Project') }}
                    </x-nav-link>
                    <x-nav-link :href="route('service-users.index')" :active="request()->routeIs('service-users.index')">
                        {{ __('Access Key') }}
                    </x-nav-link>
            ...
            <!-- Settings Dropdown id="dropdown-user" -->
