        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-600">
                                @foreach($dashboards as $dashboard)
                                    <tr class="text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600">
                                        ...
                                        <td class="px-6 py-4 cursor-pointer" onclick="window.location='{{ route('dashboards.show', $dashboard->id) }}';">{{ $dashboard->created_at->setTimezone('Asia/Jakarta')->toDateTimeString() }}</td>
                    ...
                    <p class="text-md font-light text-gray-700 dark:text-gray-100"><em>You can click your <b>"Dashboard"</b> to set up widget to visualize your data</em></p>
                    <br>
                    <div class="mb-4">
