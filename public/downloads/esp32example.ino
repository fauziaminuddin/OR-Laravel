...
const char* server = "202.10.41.74";  
const char* username = "accesskey_username"; //change with your key username from access key page, include the master:{}
...
//if you want to change ClientID, dont forget to change also in the send_topic and get_topic
